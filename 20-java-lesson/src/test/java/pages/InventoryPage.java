...
public class InventoryPage extends BasePage{
    ...
    public SelenideElement getElementInnerButton(SelenideElement el) { return el.find(cssSelector("button")); }
    public SelenideElement getShoppingBadge() { return element(xpath("//span[contains(@class, 'shopping_cart_badge')]")); }
